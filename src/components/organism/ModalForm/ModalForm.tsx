        ...
        <Dialog as="div" className="relative z-10" onClose={toShow}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full lg:max-w-[980px] transform overflow-hidden relative rounded-2xl bg-white px-4 py-8 lg:p-[50px] text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="flex flex-col gap-y-6 lg:gap-y-10">
                        ...
                        {helperData.map((chip) => {
                          return (
                            <div
                              ...
                              className={`${activeChip === chip.text ? styles.active : ''} bg-[#F1F1F1] border border-[#f1f1f1] text-[#616161] py-3 px-4 w-full rounded-full text-center cursor-pointer hover:bg-transparent hover:border-[#070809] hover:text-[#070809]`}
                            >
                        ...
                        {platformData.map((chip) => {
                          return (
                            <div
                              ...
                              className={`${activePlatform === chip.text ? styles.active : ''} bg-[#F1F1F1] border border-[#f1f1f1] text-[#616161] py-3 w-full rounded-full text-center cursor-pointer hover:bg-transparent hover:border-[#070809] hover:text-[#070809]`}
                            >
                              <p className="font-['Questrial',sans-serif] text-xs lg:text-xl leading-[100%]">
                                {chip.text}
                              </p>
                          ...
                          {aboutData.map((chip) => {
                            return (
                              <div
                                ...
                                className={`${activeAbout === chip.text ? styles.active : ''} bg-[#F1F1F1] border border-[#f1f1f1] text-[#616161] py-3 px-4 md:px-6 rounded-full text-center cursor-pointer hover:bg-transparent hover:border-[#070809] hover:text-[#070809]`}
                              >
                                <p className="font-['Questrial',sans-serif] text-xs lg:text-xl leading-[100%]">
                                  {chip.text}
                                </p>
                    ...
                    <div className="flex flex-col items-center">
                      <button
                        onClick={sendForm}
                        className="font-['Questrial',sans-serif] font-bold text-white bg-[#0046FA] rounded-full py-4 lg:py-[30px] w-full max-w-[276px] border border-[#0046FA] text-sm lg:text-xl hover:bg-transparent hover:border-[#070809] hover:text-[#070809]"
                      >
                        {t('send')}
                      </button>
                    </div>
