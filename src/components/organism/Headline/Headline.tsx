...
export const Headline = () => {
  ...
  return (
    <div className="flex flex-col items-center px-5 py-20 text-center mb-10">
      <div className="md:max-w-[868px] flex flex-col items-center gap-y-4">
        <p className="font-bold text-2xl leading-[130%] font-['Raleway',sans-serif] md:text-5xl md:leading-[64px]">
