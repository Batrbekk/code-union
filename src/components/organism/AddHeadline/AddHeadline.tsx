...
export const AddHeadline = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-y-6 text-center px-5 pb-[68px] lg:pb-24">
      <p className="font-['Raleway',sans-serif] font-bold text-2xl leading-[120%] md:text-[54px]">{t('addTitle')}</p>
      <Button
        text={t('contactUs')}
        className="py-6 md:py-7 w-full md:max-w-[278px] rounded-full bg-[#0046FA] font-bold text-sm md:text-xl"
        onClick={btnLog}
      />
    </div>
  )
